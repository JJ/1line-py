...
lenguaje que sirve para escribir *plugins* o extensiones. Es posible
que 

## Python esté en tus programas habituales.
...
una consola de Python, aunque de la versión 2. OpenOffice también
