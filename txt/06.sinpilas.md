...
También para experimentar puedes usar el sitio de programación
colaborativa [Cloud9](http://c9.io); que permite acceder a una línea
de órdenes desde el navegador, lo que nos permitirá 
...
por ejemplo, para instalar el CLI con el que vamos a trabajar en la
versión 3 de Python, que es la que hemos usado a lo largo de todo este
libro. 
...
indicado en el primer capítulo,

* instalar `pyenv` para tener la versión
...
def fact(n): \
  return 
    reduce( lambda prev,this: prev*this, range(1,n+1),1)
```
