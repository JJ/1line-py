...
como una división entera por dos. En realidad no funciona si alguno de
...
preguntando *equivalences of whatever thislenguage
...
en [StackOverflow](http://stackoverflow.com), que se inición como un
...
1. Buscar exhaustivamente por todo Google y el propio StackOverflow
   respuesta a esa pregunta y algunas más generales.
