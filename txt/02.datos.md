...
esa expresión, forzosamente ambigua, de forma diferente. Pero siempre
te van a dar alguna pista de por qué no han entendido dicha
expresión. Volvamos a Python: `TypeError: must be str, not int` te
...
Como conclusión a esta sección: si el ordenador no te comprende y te
